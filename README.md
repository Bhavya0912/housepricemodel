...
<html lang="en">
  ...
  <body>
        ...
        <div class="jumbotron jumbotron-fluid" style="background-color:rgb(23, 238, 41); ">
...
## RESULT:
Thus a website is designed to train the house price model and to predict the price and is hosted in the URL http://bhavya.student.saveetha.in:8000/HouseModelTraining, and http://bhavya.student.saveetha.in:8000/HouseModelPrediction .HTML code is validated.